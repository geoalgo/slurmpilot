...
def python_args_sbatch_string(job_info: JobCreationInfo) -> tuple[str, str]:
    """
    :return: returns two strings, one preamble and python arguments to be executed in sbatch
    """
...
def generate_python_slurm_script(
    ...
    with io.StringIO() as f:
        ...
        preamble, pythonargs = python_args_sbatch_string(job_info)
        if len(preamble) > 0:
            f.write(preamble)
